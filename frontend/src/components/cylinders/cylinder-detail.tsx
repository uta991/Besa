...
import type { Cylinder } from "@/lib/cylinders";

export function CylinderDetail({ item }: { item: Cylinder }) {
  const t = useT();
  ...
  const specs = [
    ...
    { label: t("spec.protectionLevel"), value: tValue(item.protectionLevel, locale) },
