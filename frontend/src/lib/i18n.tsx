...
const ka: Dict = {
  ...
  "spec.lockType": "საკეტის ტიპი",
  "spec.mountType": "დაყენების ტიპი",
  "spec.mechType": "მექანიზმის ტიპი",
  "spec.securityClass": "უსაფრთხოების კლასი",
  "spec.centerDist": "ცენტრამდე მანძილი",
  "spec.frontPlate": "წინა ფირფიტის სიგანე",
  "spec.plateCount": "ფირფიტების რაოდენობა",
  "spec.combos": "კომბინაცია",
  "spec.turns": "ბრუნი",
  "spec.doorThickness": "კარის სისქე",
  "spec.dimensions": "ზომები",
  "spec.boltDiameter": "რიგელის დიამეტრი",
  "spec.keyCount": "გასაღების რაოდენობა",
  "locktype.handle": "სახელურიანი",
  "locktype.additional": "დამატებითი",
  "locktype.knob": "ბურთულიანი",
  "detail.backLocks": "საკეტების სიაში დაბრუნება",
  "detail.backCylinders": "ცილინდრების სიაში დაბრუნება",
  "detail.backHandles": "სახელურების სიაში დაბრუნება",
  "detail.backAccessories": "აქსესუარების სიაში დაბრუნება",
  "spec.accessoryType": "აქსესუარის ტიპი",
  "spec.metal": "მეტალი",
  "spec.protectionLevel": "დაცვის დონე",
  "spec.security": "უსაფრთხოება",
  "search.placeholder": "ძებნა პროდუქტებში…",
  "search.none": "პროდუქტი ვერ მოიძებნა",
...
const en: Dict = {
  ...
  "spec.lockType": "Lock type",
  "spec.mountType": "Mounting",
  "spec.mechType": "Mechanism",
  "spec.securityClass": "Security class",
  "spec.centerDist": "Backset",
  "spec.frontPlate": "Faceplate width",
  "spec.plateCount": "Plates",
  "spec.combos": "Combinations",
  "spec.turns": "Turns",
  "spec.doorThickness": "Door thickness",
  "spec.dimensions": "Dimensions",
  "spec.boltDiameter": "Bolt diameter",
  "spec.keyCount": "Keys",
  "locktype.handle": "With handle",
  "locktype.additional": "Additional",
  "locktype.knob": "With knob",
  "detail.backLocks": "Back to locks",
  "detail.backCylinders": "Back to cylinders",
  "detail.backHandles": "Back to handles",
  "detail.backAccessories": "Back to accessories",
  "spec.accessoryType": "Accessory type",
  "spec.metal": "Metal",
...
const ru: Dict = {
  ...
  "spec.lockType": "Тип замка",
  "spec.mountType": "Тип установки",
  "spec.mechType": "Тип механизма",
  "spec.securityClass": "Класс безопасности",
  "spec.centerDist": "Расстояние до центра",
  "spec.frontPlate": "Ширина планки",
  "spec.plateCount": "Кол-во пластин",
  "spec.combos": "Комбинации",
  "spec.turns": "Обороты",
  "spec.doorThickness": "Толщина двери",
  "spec.dimensions": "Размеры",
  "spec.boltDiameter": "Диаметр ригеля",
  "spec.keyCount": "Кол-во ключей",
  "locktype.handle": "С ручкой",
  "locktype.additional": "Дополнительный",
  "locktype.knob": "С шаром",
  "detail.backLocks": "Назад к замкам",
  "detail.backCylinders": "Назад к цилиндрам",
  "detail.backHandles": "Назад к ручкам",
  "detail.backAccessories": "Назад к аксессуарам",
  "spec.accessoryType": "Тип аксессуара",
  "spec.metal": "Металл",
  "spec.protectionLevel": "Уровень защиты",
  "spec.security": "Безопасность",
